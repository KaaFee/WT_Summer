...
<hr>
    ...
    <form action="" method="POST" enctype ="multipart/form-data" onsubmit="return formcheck()" >
        ...
        <p id="nameerror">
            ...
            <tr>
                <label id="lnameerror">Please enter your last name<br></label>
                <td>
                    Last Name :
                </td>
                <td>
            ...
            <tr>
            <label id="ageerror">Please enter your age<br></label>
                <td>
                    Age :
                </td>
            ...
            <tr>
                ...
                <p id="radiovalue">Please select a radio Button.<br></p>
            </tr>
            <tr>
